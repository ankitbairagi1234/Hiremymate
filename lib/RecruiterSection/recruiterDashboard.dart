...
class _HomePageState extends State<RecruiterDashboard> with TickerProviderStateMixin {
  int _selBottom = 0;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          body:_recruiterPages[currentIndex] ,
        ...
        items: <Widget>[
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Image.asset(
                  'assets/drawerImages/jobpost.png',
                  height: 25.0,
                  color: currentIndex == 1 ? Colors.white :Colors.grey,
                ),
                SizedBox(height: 4,),
                Text("Post Job" , style: TextStyle(fontWeight: FontWeight.bold, fontSize: 10,
